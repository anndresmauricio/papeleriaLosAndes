...
SECRET_KEY = os.environ.get('SECRET_KEY', default='or-$%qlqe4y=pii46q0&pcmhj_35=589lt$50qqm2)!per!39p')
...
STATIC_URL = '/static/'
MEDIA_URL = 'https://papeleria-proyecto-imagenes.s3.amazonaws.com/'
...
AWS_STORAGE_BUCKET_NAME = 'papeleria-proyecto-imagenes'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Papelería Los Andes",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Papelería",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Los Andes",
    ...
    "welcome_sign": "Bienvenido a Papelería Los Andes",

    # Copyright on the footer
    "copyright": "Papelería Los Andes S.A.S",
